<?php
$ind = '
<div id="ind" class="content" style="display:none;">
<div class="header" style="position:relative; margin:auto; max-width:800px;">
    ...
    <div style="position:absolute; z-index:9; bottom:0px; right:0px; width:120px;">
    <div>
    <select id="language-ind" class="browser-default" style="border-radius:8px;" onchange="change_language(\'ind\')">
