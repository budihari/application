                  ...
                  <tr>
                     <?php
                        ...
                        foreach ($detail->result() as $row)
                        {
                           ...
                           $qty = $row->qty;
                           $subtotal = $qty * $harga;
                           $table .= '<tr><td>'.$row->nama_item.' ('.$qty.' x rp '.number_format($harga, 0, ',', '.').')</td><td style="text-align:right; width:50px;">rp</td><td style="text-align:right; width:120px;">'.number_format($subtotal, 0, ',', '.').'</td></tr>';
                        }
                        $table .= '</table>';
                     ?>
